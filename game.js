...
(() => {
  ...
  function renderWaveReward(){
    ...
    const label=c=>c.endless?(c.weapon?'ENDLOS-WAFFE':'ENDLOS-SKILL'):c.legendary?'LEGENDARY':c.ngplus2?'NG+2':c.ngplus?'NG+':c.weapon?'WAFFE':'SKILL';
